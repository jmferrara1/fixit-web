...
export type DB = {
  users: { id: string; email: string; isPro?: boolean; isAdmin?: boolean }[];
  ...
  partners?: { id: string; name: string; apiKey: string }[];
};
...
export async function readDB(): Promise<DB> {
  try {
    ...
    return { users: [], chatMessages: [], plans: [], steps: [], parts: [], partners: [] };
  }
}
